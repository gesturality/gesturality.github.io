...
function changeImage(a)
{
  ...
  if(open_ele.length == 1)
  {
       ...
       if(open_ele[0].style.backgroundImage.split("/")[2] == open_ele[1].style.backgroundImage.split("/")[2])
       {
          ...
          document.getElementsByClassName("score")[0].getElementsByTagName("li")[len-1].innerHTML="Parejas Formadas : " + String(total) + " / 18"; 
...
function setDifficulty(_mode)
{
  ...
  li_2.innerHTML="Parejas formadas  : " + String(total) + " / 18"; 
